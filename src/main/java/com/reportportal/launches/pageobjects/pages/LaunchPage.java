...
public class LaunchPage extends BasePage {
	...
	private static final String methodTypeSelected = "//span[text()='Method type']/../..//span[@class='inputDropdown__value--gzJN_']";
	private static final String statusSelected = "//span[text()='Status']/../..//span[@class='inputDropdown__value--gzJN_']";
	private static final String launchName = "span[class*='breadcrumb__link-item--pqJD2']  span";
